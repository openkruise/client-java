...
# IoOpenkruiseAppsV1alpha1StatefulSetSpec
...
**updateStrategy** | [**IoOpenkruiseAppsV1alpha1StatefulSetUpdateStrategy**](IoOpenkruiseAppsV1alpha1StatefulSetUpdateStrategy.md) | updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template. |  [optional]
