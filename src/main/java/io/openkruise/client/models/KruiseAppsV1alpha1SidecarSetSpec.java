...
public class KruiseAppsV1alpha1SidecarSetSpec {
  ...
  public KruiseAppsV1alpha1SidecarSetSpec addContainersItem(KruiseAppsV1alpha1SidecarContainer containersItem) {
   ...
   /**
   * containers contains two pieces of information: 1. normal container info that should be injected into pod 2. custom fields to control insert behavior(currently empty)
   * @return containers
  **/
  @ApiModelProperty(value = "containers contains two pieces of information: 1. normal container info that should be injected into pod 2. custom fields to control insert behavior(currently empty)")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(containers, selector);
  }
